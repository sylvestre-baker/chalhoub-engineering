...
@ApiModel({
  description: "PhoneNumberAuthRequest",
  name: "PhoneNumberAuthRequest",
})
export class PhoneNumberAuthRequest {
  @ApiModelProperty({
  ...
  @ApiModelProperty({
    description: "PhoneNumberVerificationId",
    required: true,
  })
  @Constraint(joi.string().required())
...
@ApiModel({
  description: "UserEmailRefreshTokenAuthRequest",
  name: "UserEmailRefreshTokenAuthRequest",
})
export class UserEmailRefreshTokenAuthRequest {
  @ApiModelProperty({
    description: "email",
    required: true,
  })
